...
urlpatterns = [
    ...
    path("callback/<int:pk>/", views.daraja_callback, name="mpesa-callback"),
    ...
    path('email/', views.reset_email, name='reset-email'),
    path("logout/", views.logout_user, name="logout"),
    path("signin/", views.signin, name="signin"),
    path("signup/", views.signup, name="signup"),
    path("cart/", views.cart, name="cart"),
    path("password_reset/", auth_views.PasswordResetView.as_view(template_name="password-reset.html", html_email_template_name='reset_email.html'), name='password_reset' ),
    path("password_reset/done/", auth_views.PasswordResetDoneView.as_view(template_name="password_reset_done.html"), name='password_reset_done' ),
    path("reset/<uidb64>/<token>/", auth_views.PasswordResetConfirmView.as_view(template_name="password-reset-confirm.html", extra_context={'invalid_link': True}), name='password_reset_confirm' ),
